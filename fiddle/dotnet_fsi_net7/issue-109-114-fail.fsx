...
System.FormatException: The format of value '' is invalid.
   ...
   at RestInPeace.Request.toAsync@133-4.Invoke(CancellationToken ctok)
...
--- End of stack trace from previous location ---
   ...
   at <StartupCode$FSI_0002>.$FSI_0002.main@() in C:\Users\ronal\source\repos\github\RestInPeace\fiddle\dotnet_fsi_net7\issue-109-114.fsx:line 10
   at System.RuntimeMethodHandle.InvokeMethod(Object target, Void** arguments, Signature sig, Boolean isConstructor)
   at System.Reflection.MethodInvoker.Invoke(Object obj, IntPtr* args, BindingFlags invokeAttr)
*)

#r "nuget: RestInPeace, 9.0.0"
